...
ALLOWED_HOSTS=['hyderabadinsaudi-production.up.railway.app','hydinsaudi.com','127.0.0.1']
...
if not DEBUG:
    CSRF_TRUSTED_ORIGINS = ['https://hyderabadinsaudi-production.up.railway.app','https://hydinsaudi.com']
