...
def registerUser(request):
    if request.user.is_authenticated:
        ...
        if form.is_valid():
            ...
            phone_number = '0'
            company = 'x'
            user = User.objects.create_user(first_name=first_name,last_name=last_name, username=username,email=email, password=password, phone_number=phone_number, company=company)
...
def bbgreg(request):
    ...
    return render(request, 'bbg/regassociate.html', context)
